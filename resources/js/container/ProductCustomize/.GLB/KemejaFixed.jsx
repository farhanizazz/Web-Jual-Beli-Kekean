...
export function KemejaFixed(props) {
  ...
  textureDadaKanan.map.flipY = false
  textureDadaKiri.map.flipY = false
  textureKerah.map.flipY = false
  textureKancing.map.flipY = false
